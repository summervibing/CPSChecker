...
/**
 * Interface which provides methods to interact with
 * version-dependent protocol features of Minecraft.
 */
public interface ProtocolAdapter {
    ...
    /**
     * Gets the {@link MinecraftVersion} of the current implementation.
     *
